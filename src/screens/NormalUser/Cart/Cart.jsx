          ...
          <section className="w-11/12 flex justify-center items-center pb-28">
            ...
            <Box sx={{ width: "100%" }}>
              ...
              {activeStep === steps.length ? (
                ...
                <React.Fragment>
                  <section className="flex flex-col bg-[#1e1e1e] p-5 mt-4 rounded-t-md">
                    {activeStep === 0 ? (
                      <div className="flex  flex-col gap-4">
                        {/* 1 */}
                        <div className="flex flex-col gap-3">
                          <section className="flex gap-2 items-center">
                            <span className=" w-8 h-8 p-2 flex items-center justify-center rounded-full border-[2px] border-[#4675C0] ">
                              1
                            </span>
                          ...
                          <Link to="/imprimir">
                            <span className="text-[#4675C0] text-[14px] hover:text-blue-500 underline">
                  ...
                  <Box className="bg-[#1e1e1e] rounded-b-md p-4 flex justify-between items-center">
                    <section onClick={(e) => handleDeleteCart(e)}>
                      <button className="text-[#4675C0] text-[14px] hover:text-blue-500 underline">
                        Vaciar carrito
                      </button>
                    </section>
                    <section>
